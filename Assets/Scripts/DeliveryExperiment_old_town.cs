...
//             } else if (VALUE_COURIER && isFirstSession)
//             {
//                 Debug.Log("Town Learning Phase");
//                 trialsForFirstSubSession = Config.trialsPerSessionSingleTownLearning;
//                 messageImageDisplayer.SetGeneralMessageText("town learning title", "town learning main 1");
...
//         }
//         // ZR: NEW devlieries from deliveries - 1
...
//             {
//                 // ZR: Make sure no index out of bounds error
...
//                 yield return DoRecall(trialNumber, trialNumber, practice: true, freeFirst: false);
//             else
...
//         // ZR: get rid randomization if value always first
//         if (Config.valueAlwaysFirst)
//         {
